...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__helloResponse(struct soap*, const char*, int, const ns1__helloResponse *, const char*);
SOAP_FMAC3 ns1__helloResponse * SOAP_FMAC4 soap_in_ns1__helloResponse(struct soap*, const char*, ns1__helloResponse *, const char*);

#ifndef soap_write_ns1__helloResponse
#define soap_write_ns1__helloResponse(soap, data) ( soap_begin_send(soap) || ((data)->soap_serialize(soap), 0) || (data)->soap_put(soap, "ns1:helloResponse", NULL) || soap_end_send(soap) )
#endif


#ifndef soap_read_ns1__helloResponse
...
SOAP_FMAC3 ns1__helloResponse * SOAP_FMAC4 soap_get_ns1__helloResponse(struct soap*, ns1__helloResponse *, const char*, const char*);
...
SOAP_FMAC1 ns1__helloResponse * SOAP_FMAC2 soap_instantiate_ns1__helloResponse(struct soap*, int, const char*, const char*, size_t*);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__hello(struct soap*, const char*, int, const ns1__hello *, const char*);
SOAP_FMAC3 ns1__hello * SOAP_FMAC4 soap_in_ns1__hello(struct soap*, const char*, ns1__hello *, const char*);

#ifndef soap_write_ns1__hello
#define soap_write_ns1__hello(soap, data) ( soap_begin_send(soap) || ((data)->soap_serialize(soap), 0) || (data)->soap_put(soap, "ns1:hello", NULL) || soap_end_send(soap) )
#endif


#ifndef soap_read_ns1__hello
#define soap_read_ns1__hello(soap, data) ( soap_begin_recv(soap) || !soap_get_ns1__hello(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 ns1__hello * SOAP_FMAC4 soap_get_ns1__hello(struct soap*, ns1__hello *, const char*, const char*);
...
SOAP_FMAC1 ns1__hello * SOAP_FMAC2 soap_instantiate_ns1__hello(struct soap*, int, const char*, const char*, size_t*);
...
#define soap_write___ns1__hello(soap, data) ( soap_begin_send(soap) || (soap_serialize___ns1__hello(soap, data), 0) || soap_put___ns1__hello(soap, data, "-ns1:hello", NULL) || soap_end_send(soap) )
#endif
...
#define soap_read___ns1__hello(soap, data) ( soap_begin_recv(soap) || !soap_get___ns1__hello(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 struct __ns1__hello * SOAP_FMAC4 soap_get___ns1__hello(struct soap*, struct __ns1__hello *, const char*, const char*);

#define soap_new___ns1__hello(soap, n) soap_instantiate___ns1__hello(soap, n, NULL, NULL, NULL)


#define soap_delete___ns1__hello(soap, p) soap_delete(soap, p)
...
#ifndef SOAP_TYPE_PointerTons1__helloResponse
#define SOAP_TYPE_PointerTons1__helloResponse (14)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTons1__helloResponse(struct soap*, ns1__helloResponse *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTons1__helloResponse(struct soap*, const char *, int, ns1__helloResponse *const*, const char *);
SOAP_FMAC3 ns1__helloResponse ** SOAP_FMAC4 soap_in_PointerTons1__helloResponse(struct soap*, const char*, ns1__helloResponse **, const char*);

#ifndef soap_write_PointerTons1__helloResponse
#define soap_write_PointerTons1__helloResponse(soap, data) ( soap_begin_send(soap) || (soap_serialize_PointerTons1__helloResponse(soap, data), 0) || soap_put_PointerTons1__helloResponse(soap, data, "ns1:helloResponse", NULL) || soap_end_send(soap) )
#endif

SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTons1__helloResponse(struct soap*, ns1__helloResponse *const*, const char*, const char*);

#ifndef soap_read_PointerTons1__helloResponse
#define soap_read_PointerTons1__helloResponse(soap, data) ( soap_begin_recv(soap) || !soap_get_PointerTons1__helloResponse(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 ns1__helloResponse ** SOAP_FMAC4 soap_get_PointerTons1__helloResponse(struct soap*, ns1__helloResponse **, const char*, const char*);

#ifndef SOAP_TYPE_PointerTons1__hello
#define SOAP_TYPE_PointerTons1__hello (13)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTons1__hello(struct soap*, ns1__hello *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTons1__hello(struct soap*, const char *, int, ns1__hello *const*, const char *);
SOAP_FMAC3 ns1__hello ** SOAP_FMAC4 soap_in_PointerTons1__hello(struct soap*, const char*, ns1__hello **, const char*);

#ifndef soap_write_PointerTons1__hello
#define soap_write_PointerTons1__hello(soap, data) ( soap_begin_send(soap) || (soap_serialize_PointerTons1__hello(soap, data), 0) || soap_put_PointerTons1__hello(soap, data, "ns1:hello", NULL) || soap_end_send(soap) )
#endif

SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTons1__hello(struct soap*, ns1__hello *const*, const char*, const char*);

#ifndef soap_read_PointerTons1__hello
#define soap_read_PointerTons1__hello(soap, data) ( soap_begin_recv(soap) || !soap_get_PointerTons1__hello(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 ns1__hello ** SOAP_FMAC4 soap_get_PointerTons1__hello(struct soap*, ns1__hello **, const char*, const char*);
